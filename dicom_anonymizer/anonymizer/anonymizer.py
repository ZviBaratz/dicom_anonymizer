...
from dicom_anonymizer.anonymizer.scan_directory import ScanDirectory
...
from dicom_anonymizer.utils import path_generator
...
class Anonymizer:
    def __init__(
        ...
        self.scan_directory = ScanDirectory(scan_directory)
    ...
    def anonymize_dicom(self, dicom_handler: DicomHandler,
        ...
        self.scan_directory.create_from_dicom(dicom_handler)
